...
export const skeletons = [
  {name:"伟大出发·长征源流线",angle:"以中央红军集结出发为叙事主轴",core:["Y02","Y04","Y03"],background:"这条路线围绕中央红军在于都集结、渡河、告别苏区并踏上长征的关键时刻展开。纪念馆提供完整史实框架，纪念碑与渡口把宏大的历史转化为可站立、可凝望、可追问的现场记忆，适合把长征精神、群众支前和青年实践任务放在同一条叙事线上理解。"},
  {name:"井冈星火·道路探索线",angle:"从理论探索到军事实践",core:["J01","J05","J04"],background:"路线以井冈山革命根据地的创建与发展为主线，从博物馆建立整体时间线，到茅坪八角楼理解理论探索，再到黄洋界哨口进入山地斗争现场。它适合呈现中国革命道路探索如何在组织建设、军事斗争和群众基础之间逐步成形。"},
  {name:"信仰铸魂·初心教育线",angle:"突出重要人物与革命精神",core:["J01","J02","J03"],background:"这条路线强调理想信念教育和革命精神传承。博物馆提供史料脉络，烈士陵园形成庄重的纪念场域，茨坪旧址群则把革命者的工作与生活空间连接起来，帮助团队从人物、组织和日常实践中理解初心的具体形态。"},
  {name:"军民同心·群众支前线",angle:"看见革命胜利背后的群众力量",core:["Y03","Y05","Y06","Y07"],background:"路线把于都河畔的送别、宗祠空间的保障、地方党组织与苏维埃政权旧址串联起来，重点观察群众动员、物资支援和基层组织如何支撑革命行动。它适合社会实践团队围绕群众路线、地方治理和红色资源活化开展调研。"},
  {name:"行走课堂·实践观察线",angle:"强调现场观察与身体体验",core:["J03","J09","J06"],background:"这条路线把旧址参观与行走体验结合起来，让团队在茨坪旧址群建立现场认知，再通过挑粮小道感受山地交通和物资保障的艰辛，最后回到小井红军医院旧址理解保障体系与牺牲精神。路线适合做观察记录、访谈和研学任务。"},
  {name:"新长征·时代发展线",angle:"连接红色记忆与乡村振兴",core:["Y01","Y10","Y05"],background:"路线从长征出发地的历史记忆出发，延伸到潭头村等当代乡村样本，再回看地方宗祠与群众支援旧址。它把红色文化传承、乡村振兴和青年实践结合起来，适合形成面向地方发展的观察报告或实践建议。"},
  {name:"共和国摇篮·苏区政权线",angle:"从叶坪到沙洲坝理解治国理政探索",core:["R01","R04","R03"],background:"路线聚焦瑞金中央苏区政权建设，叶坪旧址群呈现临时中央政府诞生，二苏大旧址展示制度建设场景，中央苏区博物馆补足历史脉络。适合围绕共和国摇篮、制度探索和苏区干部作风进行专题学习。"},
  {name:"饮水思源·群众路线",angle:"从红井故事理解初心与群众工作",core:["R02","R01","R06"],background:"这条路线以红井故事为情感入口，连接叶坪旧址群和中华苏维埃纪念园，强调党与群众之间的关系如何在具体生活问题中被建立和巩固。它适合开展初心教育、群众路线教育和仪式性总结活动。"},
  {name:"军旗升起·英雄城线",angle:"沿八一起义旧址追溯人民军队创建",core:["N01","N04","N02"],background:"路线围绕南昌起义与人民军队创建展开，从纪念馆进入起义决策与战斗过程，再到指挥部旧址和纪念塔完成城市空间中的历史追溯。它适合在较短时间内完成高密度、城市型红色研学。"},
  {name:"工运先声·安源初心线",angle:"理解早期工人运动与群众组织",core:["A01","A02","A03"],background:"路线聚焦安源路矿工人运动，以纪念馆梳理早期工运脉络，以工人俱乐部旧址观察基层组织空间，再以秋收起义广场形成历史延伸。它适合把群众动员、组织建设和革命事件串联成一条清晰的学习线。"},
  {name:"信仰如炬·上饶英烈线",angle:"在狱中斗争遗址体悟信仰与气节",core:["S01","S02","S03"],background:"路线以上饶集中营旧址体系为核心，结合方志敏纪念馆，呈现革命者在严酷环境中的信仰坚守、狱中斗争与精神传承。它更适合主题党日、信仰教育和英烈纪念类团队活动。"},
  {name:"调查研究·苏区作风线",angle:"以长冈乡、寻乌调查理解群众路线",core:["XG2","XG3","XW1"],background:"路线围绕调查研究传统展开，从长冈乡调查到寻乌调查，把方法论学习放回苏区社会现场。团队可以比较不同点位的调查对象、问题意识与工作作风，理解实事求是如何从基层经验中生成。"},
  {name:"军民同心·将军县线",angle:"从兴国支前史理解苏区军民关系",core:["XG1","XG2","XG3"],background:"路线集中在兴国展开，通过将军园、长冈乡调查纪念馆和潋江书院旧居理解参军支前、群众动员与干部作风之间的关系。它适合用较紧凑的行程完成一个区域内的深度主题学习。"},
  {name:"反围剿·中央苏区军事线",angle:"连接宁都起义与苏区军事斗争",core:["ND1","ND2","R05"],background:"路线连接宁都和瑞金，围绕宁都起义、中央苏区军事指挥与反“围剿”历史展开。它适合关注军事斗争、队伍建设和中央苏区战略空间的团队，行程上会优先完成同一区域点位后再跨区域接续。"},
  {name:"百年征程·江西党史线",angle:"从革命年代延伸至建设时期",core:["N01","J01","LS1"],background:"这条路线跨度较大，从南昌起义、井冈山斗争延伸到庐山会议旧址，用跨时期的方式观察江西在中国共产党历史中的多个重要坐标。它适合时间较充裕、希望建立全省党史纵深认识的团队。"},
];
