...
export const skeletons = [
  {name:"伟大出发·长征源流线",angle:"以中央红军集结出发为叙事主轴",core:["Y02","Y04","Y03"],background:"到于都看长征，最好先把“为什么从这里出发”讲明白。纪念馆负责把时间线理清，纪念碑和东门渡口则把告别、渡河、出发这些瞬间落到眼前。走完这一段，长征不再只是书上的几个字，而是一群人、一条河和一次真正艰难的启程。"},
  {name:"井冈星火·道路探索线",angle:"从理论探索到军事实践",core:["J01","J05","J04"],background:"井冈山这条线不要急着赶点。先在博物馆把根据地的来龙去脉看清楚，再到八角楼想一想当年怎样在困境里找路，最后去黄洋界看山势、看哨口，也看军民一起守住根据地的那股劲。"},
  {name:"信仰铸魂·初心教育线",angle:"突出重要人物与革命精神",core:["J01","J02","J03"],background:"这条线更适合慢下来。博物馆讲的是历史脉络，烈士陵园让人真正停一停，茨坪旧址群则把革命者工作的地方、生活的地方摆到眼前。它不是简单打卡，而是让人从具体空间里感受到“初心”到底落在哪里。"},
  {name:"军民同心·群众支前线",angle:"看见革命胜利背后的群众力量",core:["Y03","Y05","Y06","Y07"],background:"如果想看见群众支前，不妨从于都河边开始。渡口、宗祠、省委旧址和苏维埃旧址连起来，会发现革命不是少数人的孤军奋战，背后有送别的人、筹粮的人、组织起来办事的人。这个角度很适合做社会实践和访谈记录。"},
  {name:"行走课堂·实践观察线",angle:"强调现场观察与身体体验",core:["J03","J09","J06"],background:"这条线的重点是“走进去”。在茨坪旧址群先看组织怎样运转，再去挑粮小道用脚感受山路和物资运输的难，最后到小井红军医院旧址看战地救护和后勤保障。身体一参与，很多历史细节会变得更实在。"},
  {name:"新长征·时代发展线",angle:"连接红色记忆与乡村振兴",core:["Y01","Y10","Y05"],background:"这条线不只回望过去，也看看今天。长征出发地讲的是历史起点，潭头村能看到红色资源怎样进入当代乡村生活，再回到宗祠旧址，就能把群众支援、地方文化和乡村发展放在一起想。"},
  {name:"共和国摇篮·苏区政权线",angle:"从叶坪到沙洲坝理解治国理政探索",core:["R01","R04","R03"],background:"瑞金这条线适合带着一个问题走：一个新的政权当年是怎样被组织起来的？叶坪看起点，二苏大看制度探索，中央苏区博物馆再把零散信息收束起来。走完以后，对“共和国摇篮”会有更具体的理解。"},
  {name:"饮水思源·群众路线",angle:"从红井故事理解初心与群众工作",core:["R02","R01","R06"],background:"红井故事容易让人记住，但它背后讲的是更长久的群众关系。先从沙洲坝进入，再到叶坪和纪念园回看苏区建设，会发现“为群众办事”不是一句口号，而是从吃水、生活和组织工作里一点点做出来的。"},
  {name:"军旗升起·英雄城线",angle:"沿八一起义旧址追溯人民军队创建",core:["N01","N04","N02"],background:"南昌的好处是城市点位集中，节奏可以紧凑一些。纪念馆讲清起义前后，贺龙指挥部旧址把指挥空间带到眼前，纪念塔则适合做一个收束。短时间里，也能把人民军队创建这条线走得比较完整。"},
  {name:"工运先声·安源初心线",angle:"理解早期工人运动与群众组织",core:["A01","A02","A03"],background:"安源这条线的关键词是“组织起来”。纪念馆先讲早期工运，工人俱乐部旧址让人看到工人组织活动的空间，秋收起义广场再把历史往后接一段。它很适合讨论群众动员为什么重要。"},
  {name:"信仰如炬·上饶英烈线",angle:"在狱中斗争遗址体悟信仰与气节",core:["S01","S02","S03"],background:"上饶这条线会更沉一些。集中营纪念馆和茅家岭监狱旧址让人直面狱中斗争的艰难，方志敏纪念馆则把信仰、文字和人格力量接起来。这里不需要太多口号，现场本身就很有分量。"},
  {name:"调查研究·苏区作风线",angle:"以长冈乡、寻乌调查理解群众路线",core:["XG2","XG3","XW1"],background:"这条线适合带着笔记本走。长冈乡调查、潋江书院和寻乌调查连起来，讲的是怎样下到基层、怎样问问题、怎样从真实生活里找到判断。它特别适合做调研方法训练。"},
  {name:"军民同心·将军县线",angle:"从兴国支前史理解苏区军民关系",core:["XG1","XG2","XG3"],background:"兴国这条线相对集中，适合做深一点。将军园讲参军支前，长冈乡调查纪念馆讲干部作风，潋江书院旧居补上人物与地方实践。几处点位连起来，会更容易理解“将军县”背后的群众基础。"},
  {name:"反围剿·中央苏区军事线",angle:"连接宁都起义与苏区军事斗争",core:["ND1","ND2","R05"],background:"这条线会跨到宁都和瑞金，适合对军事斗争感兴趣的团队。宁都起义、小布旧址群和中革军委旧址连起来，可以把队伍变化、前线指挥和中央苏区军事空间放在一张图里看。路线会尽量先走完一个区域，再接到下一段。"},
  {name:"百年征程·江西党史线",angle:"从革命年代延伸至建设时期",core:["N01","J01","LS1"],background:"这条线跨度最大，不追求轻松，但很有纵深。从南昌起义到井冈山斗争，再到庐山会议旧址，几个坐标放在一起看，江西在党史中的分量会变得清楚。适合时间更充裕、想看全局的团队。"},
];
